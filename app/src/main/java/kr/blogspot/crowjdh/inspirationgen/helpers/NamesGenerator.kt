 ...
 *
 * NamesGenerator
 *  Kotlin port of Docker's names-generator.go at 15, May, 2016:
 *  https://github.com/docker/docker/blob/master/pkg/namesgenerator/names-generator.go
 */

val left: Array<String>
    get() = arrayOf("admiring", "adoring", "agitated", "amazing", "angry", "awesome",
...
fun generateRandomName(postfix: Int? = null): String {
    ...
    return if (postfix != null) "$name$postfix" else name
}
